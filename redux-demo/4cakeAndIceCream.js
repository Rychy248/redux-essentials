...
function main() {
  ...
  const store = redux.createStore(rootReducer, redux.applyMiddleware(logger)); // using middleware for redux
  

  // adding a listener
  // const unsubscribeLog = store.subscribe(()=>{ 
  //   console.log(`State was update: `,JSON.stringify(store.getState()));
  // }); ----------- NO MORE NECESSARY - THE LOGGER, REDUX-LOGGER, WILL DO IT FOR US AS A MIDDLEWARE
